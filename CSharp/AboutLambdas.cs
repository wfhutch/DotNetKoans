...
namespace DotNetKoans.CSharp
{
	public class AboutLambdas : Koan
	{
		...
		public void UsingAnonymousMethods()
		{
			...
			var result = System.Array.ConvertAll(numbers, delegate(int x)
													{
														return x.ToString();
													});
		...
		public void AnonymousMethodsCanAccessOuterVariables()
		{
			...
			int toFind = 7;
            Assert.Equal(3, System.Array.FindIndex(numbers, delegate(int x)
													{
														return x == toFind;
													}));
		}
		...
		public void AccessEvenAfterVariableIsOutOfScope()
		{
            ...
            Assert.Equal(3, System.Array.FindIndex(numbers, criteria));
		}
		[Koan(4)]
		public void LambdaExpressionsAreShorthand()
		{
			var numbers = new[] { 1, 2, 3, 4 };
			var anonymous = System.Array.ConvertAll(numbers, delegate(int x)
													{
														return x.ToString();
													});
			...
			//        |----------------------------|        |
			//                                    \|/      \|/
			var lambda = System.Array.ConvertAll(numbers,  (int x) => 
													{
														return x.ToString(); 
													});
		...
		public void TypeCanBeInferred()
		{
			...
			var lambda = System.Array.ConvertAll(numbers, (x) =>
